...
@section('body')
    <div class="flex flex-col justify-center flex-1 mx-auto my-32">
        <span class="mb-1 font-bold leading-none text-gray-900 text-homepage-title">Hi!</span>
        <h1 class="p-0 m-0 mt-6 text-5xl leading-none tracking-tight sm:mt-2">I'm Joko Susilo. <span class="block sm:inline">A web developer.</span></h1>
        ...
        <div>
            <a href="https://twitter.com/joko_susilo_" target="_blank" class="inline-block w-10 icon-26 twitter" title="Twitter">
            ...
            <a href="https://github.com/jokosusilo" target="_blank" class="inline-block w-10 icon-13 github" title="GitHub">
                <svg viewBox="0 0 512 512" class="text-gray-900 fill-current hover:text-primary">
            ...
            <a href="mailto:jksusilo28@gmail.com?Subject=Hello!" class="inline-block w-10 icon-8 email" title="Email">
                <svg viewBox="0 0 512 512" class="text-gray-900 fill-current hover:text-primary">
        ...
        <div class="hidden p-4 my-4 border-2 border-black border-dotted">
            <div class="text-xl font-bold text-black">I'm available for hire!</div>
            <p class="p-0 my-0">
